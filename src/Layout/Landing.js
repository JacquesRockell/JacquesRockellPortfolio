    ...
    return (
        <section data-pagenum={0}>
            <div className="landing w-full flex z-50 isolate relative">
                ...
                <div className={scroll ? "scroll-reminder" : "scroll-reminder active animate-pulse"}><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-arrow-down-short" viewBox="0 0 16 16">
